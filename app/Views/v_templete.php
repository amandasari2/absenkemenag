        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="#" class="navbar-brand mx-4 mb-3">
                    <h5 class="text-primary"><i class="fa fa-hashtag me-2"></i>Kementerian Agama</h5>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="<?= base_url('uploads/' . $user['foto']) ?>" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <a href="<?= base_url('dashboard') ?>" class="nav-item nav-link <?= $menu == 'dashboard' ? 'active' : '' ?>"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="<?= base_url('pegawai') ?>" class="nav-item nav-link <?= $menu == 'pegawai' ? 'active' : '' ?>"><i class="fa fa-th me-2"></i>Data Pegawai</a>
                    <a href="<?= base_url('absensi') ?>" class="nav-item nav-link <?= $menu == 'absensi' ? 'active' : '' ?>"><i class="fa fa-keyboard me-2"></i>Absen Pegawai</a>
                    <a href="<?= base_url('qrcodepegawai') ?>" class="nav-item nav-link <?= $menu == 'qrcodepegawai' ? 'active' : '' ?>"><i class="fa fa-qrcode me-2"></i>QR Code Pegawai</a>
                    <a href="<?= base_url('laporanabsen') ?>" class="nav-item nav-link <?= $menu == 'laporanabsen' ? 'active' : '' ?>"><i class="fa fa-file-alt me-2"></i>Laporan Absen</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="<?= base_url('uploads/' . $user['foto']) ?>" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex"><?= $user['nama'] ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="<?= base_url('user/profil/' . $user['id']) ?>" class="dropdown-item">My Profile</a>
